...
Wireframe the client application before you build anything; what components will you need? What data will each component hold? What will the hierarchy of components be?
