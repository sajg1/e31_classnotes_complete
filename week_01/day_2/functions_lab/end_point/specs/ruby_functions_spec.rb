...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(4188.79, volume.round(2))
  end

  def test_volume_of_sphere__tiny_number()
    volume = volume_of_sphere(0.000000000000005)
    assert_equal(5.2359877559829886e-43, volume)
  end
